            ...
            <div className="col-12 col-lg-6">
              <div className="row justify-content-xl-end">
                <div className="col-12 col-xl-11 mb-5">
                  <h2 className="h1 mb-3 pb-3 pt-5" style={{
                color: '#fff'
              }}>How can we help you?</h2>
                  <p className="fs-5 text-secondary mb-5" style={{
                color: '#fff !important'
              }}>We hope you have found an answer to your question. If you need any help, please search your query on our Support Center or contact us via email.</p>
