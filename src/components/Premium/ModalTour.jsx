...
const ModelTour = () => {
  return (
    <div className="modal modal-sheet position-static d-block bg-body-secondary p-5 py-md-5" tabIndex="-1" role="dialog" id="modalTour" style={{ backgroundColor: '#60aaf4', fontFamily: "'Be Vietnam Pro', sans-serif" }}>
      ...
      <li className="d-flex gap-3">
        ...
        <div>
          ...
          Share Books wherever you go.
            ...
            <button type="button" className="btn btn-lg btn-primary mt-3 w-100" style={{ backgroundColor: '#60aaf4', border: 'none' }} data-bs-dismiss="modal">
              Discover More!
            </button>
          </div>
        </div>
